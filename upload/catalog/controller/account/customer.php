...
class ControllerAccountCustomer extends Controller{
    ...
    protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('account/customer', 'user_token=' . $this->session->data['user_token'] . $url)
		);
		...
		$customer_total = $this->model_account_customer->getTotalCustomers($filter_data);
